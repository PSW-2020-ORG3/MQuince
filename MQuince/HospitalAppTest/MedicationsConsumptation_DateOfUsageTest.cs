...
namespace HospitalAppTest
{
    ...
    {   
        ...
        public  void Date_when_some_medications_are_used()
        {
            ...
            IEnumerable<IdentifiableDTO<MedicationsConsumptionDTO>> medicationReporst = medicationService.getConsumptionBetweenDates(new DateTime(2020, 10, 09), new DateTime(2020, 10, 15));
        ...
        public void Date_when_some_medications_are_not_used()
        {
            ...
            IEnumerable<IdentifiableDTO<MedicationsConsumptionDTO>> medicationReporst = medicationService.getConsumptionBetweenDates(new DateTime(2020, 09, 02), new DateTime(2020, 09, 05));
