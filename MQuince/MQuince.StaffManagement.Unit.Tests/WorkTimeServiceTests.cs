...
namespace MQuince.StaffManagement.Unit.Tests
{
    public class WorkTimeServiceTests
    {
        ...
        private WorkTime GetFirstWorkTime()
                => new WorkTime(new DateTime(2020, 12, 01), new DateTime(2020, 12, 22), 8, 14, Guid.Parse("7bb28807-f41e-4bf4-b699-6a478051adba"));


        private WorkTime GetSecondWorkTime()
           => new WorkTime(new DateTime(2020, 12, 23), new DateTime(2020, 12, 27), 14, 20, Guid.Parse("7bb28807-f41e-4bf4-b699-6a478051adba"));
